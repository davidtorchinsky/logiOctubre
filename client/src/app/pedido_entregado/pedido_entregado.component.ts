...
import { PedidoEntregadoService } from './pedido_entregado.service';
...
@Component({
    ...
    templateUrl: './pedido_entregado.component.html',
    styleUrls: ['./pedido_entregado.component.css'],
    animations: [routerTransition()]
})
export class PedidoEntregadoComponent implements OnInit {
  model: any = {};
  pedidos: Pedido[] = [];
  cols: any[];
  ...
  constructor(
    private pedidoService: PedidoEntregadoService,
